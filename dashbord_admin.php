                    ...
                    <div class="card-body">
                        ...
                        <table id="datatablesSimple" class="table table-light">
                            ...
                            <tbody>
                                ...
                                // SQL for fetching lessons without filtering by user
                                $sql = "SELECT * FROM lessons WHERE lessonName LIKE ? LIMIT ?, ?";
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="ad_lesson_del.php?lessonID=<?= htmlspecialchars($row["lessonID"]) ?>"
                                ...
                                $countSql = "SELECT COUNT(*) as total FROM lessons WHERE lessonName LIKE ?";
                                $countStmt = $conn->prepare($countSql);
                                // Bind the search parameter for counting lessons
