let sectionCount = 1; //เก็บจำนวนของsection ที่เริ่มต้น 1
let topicCount = 0;  // เก็บจำนวนของ topic 

function updateContent(sectionNumber) { //อัปเดตเนื้อหาที่เลือกจาก dropdown
    const selectElement = document.getElementById("sectionContent" + sectionNumber); 
    const selectedValue = selectElement.value; //เก็บค่าที่ผู้ใช้เลือกไว้ในตัวเเปร selectedValue
